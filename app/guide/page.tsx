...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "적정 원가율 기준", href: "#", desc: "카페 25~30%, 음식점 30~35%, 바 20~28%가 업계 평균입니다. VELA 벤치마크에서 확인하세요." },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "4대보험 계산 팁", href: "#", desc: "직원 급여의 약 9.4%가 사업주 부담 4대보험료입니다. 인건비 계획 시 반드시 포함하세요." },
    ],
  },
  {
    title: "매출 성장",
