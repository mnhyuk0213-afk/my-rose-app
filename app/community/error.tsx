    ...
    <main className="min-h-screen bg-slate-50 pt-20 pb-16 px-4 flex items-center justify-center">
      <div className="mx-auto max-w-md text-center">
        ...
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/community" className="rounded-xl bg-white ring-1 ring-slate-200 text-slate-700 font-semibold px-5 py-2.5 text-sm hover:bg-slate-50 transition">돌아가기</Link>
        </div>
      </div>
    </main>
  );
